...
public class GuardarFracciones extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
       ...
       int nodo_usuario=Integer.parseInt(request.getParameter("nodo_usuario"));
        ...
        try {
            ModificarNodo(request.getRealPath("/")+"\\xml\\Modulo_Profesor.xml",datos,nodo_usuario);
...
public static void ModificarNodo(String archivo_direccion,String datos[],int nodo_usuario) throws Exception {
    ...
    usuario.getParentNode().replaceChild(creados, usuario);
