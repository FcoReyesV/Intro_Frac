...
"                	</select>\n" +
"				</div>	\n" +
                    "<div id='cargar' class='btn-lateral'>"+
                    "<button>Cargar</button>"+
                    "</div>"+
                    "<div id='nuevo' class='btn-lateral'>"+
                    "<button>Nuevo</button>"+
                    "</div>"+
                    "<div id='eliminar' class='btn-lateral'>"+
...
"					</div>\n" +
"					<div id=\"contenedor-objetos-draggables\">"
                                        + "<img id=\"contenedorfrente\" src=\"images/contenedorfrente.png\"/>\n" +
"					<img id=\"contenedorfondo\" src=\"images/contenedorfondo.png\"/>"
                                        + "</div>\n" +
"				</div>\n" +
"				\n" +
"					\n" +
