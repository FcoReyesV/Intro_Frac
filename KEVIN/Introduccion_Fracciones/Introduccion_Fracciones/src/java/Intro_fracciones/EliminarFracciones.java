...
public class EliminarFracciones extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            EliminarNodo(request.getRealPath("/")+"\\xml\\Modulo_Profesor.xml",nodo_usuario);
    ...
    public static void EliminarNodo(String archivo_direccion,int nodo_usuario) throws Exception {
